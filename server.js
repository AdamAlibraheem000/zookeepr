...
// function to write to animals.json file
function createNewAnimal(body, animalsArray) {
  ...
  fs.writeFileSync(
    ...
    // null means we do NOT want to edit existing data. 2 indicates white space between data
  );
...
app.post("/api/animals", (req, res) => {
  ...
  // Will only work if we do not delete any values in the json file
